...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ESB, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ESB_MAX_PAYLOAD_LENGTH, 32);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ESB_TX_FIFO_SIZE, 8);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ESB_RX_FIFO_SIZE, 8);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ESB_PIPE_COUNT, 8);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ESB_RADIO_IRQ_PRIORITY, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ESB_EVENT_IRQ_PRIORITY, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ESB_SYS_TIMER2, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HAS_NO_PM, 1);
