...
MEMORY
    {
    FLASH (rx) : ORIGIN = (0x1000000 + 0x0), LENGTH = (256*1K - 0x0)
    SRAM (wx) : ORIGIN = 0x21000000, LENGTH = (64 * 1K)
 ...
 *(.iplt)
 ...
 __rom_region_start = (0x1000000 + 0x0);
    rom_start :
 {
. = 0x0;
. = ALIGN(4);
 ...
 *(".kernel_noinit.*")
    ...
    _image_ram_end = .;
    _end = .;
    __kernel_ram_end = 0x21000000 + (64 * 1K);
