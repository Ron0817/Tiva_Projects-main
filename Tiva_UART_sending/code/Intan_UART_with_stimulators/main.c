...
#define    SAMPLING_FREQ            1500
#define    BUFFER_SIZE              4096
#define    CUTOFF_UPPER             20000
#define    CUTOFF_LOWER             1
//#define    CHANNEL_NUM       8
#define    FILE_SECONDS             5
#define    READ_CHAN_0              8
//****************Stimulator 0***************//
#define    STIM_ON_0                0         //1 for on, 0 for off
#define    STIM_CHAN_NUM_0          0         //Stimulation channel number
#define    STIM_PERIOD_0            150000    //us
#define    STIM_POS_PULSE_MAG_0     200000    //nA
#define    STIM_POS_PULSE_WIDTH_0   30000     //us
#define    STIM_NEG_PULSE_MAG_0     50000     //nA
#define    STIM_NEG_PULSE_WIDTH_0   30000     //us

//****************Stimulator 1***************//
#define    STIM_ON_1                0         //1 for on, 0 for off
#define    STIM_CHAN_NUM_1          1         //Stimulation channel number
#define    STIM_PERIOD_1            300000    //us
#define    STIM_POS_PULSE_MAG_1     100000    //nA
#define    STIM_POS_PULSE_WIDTH_1   50000     //us
#define    STIM_NEG_PULSE_MAG_1     100000     //nA
#define    STIM_NEG_PULSE_WIDTH_1   50000     //us

//****************Stimulator 2***************//
#define    STIM_ON_2                0         //1 for on, 0 for off
#define    STIM_CHAN_NUM_2          2         //Stimulation channel number
#define    STIM_PERIOD_2            200000    //us
#define    STIM_POS_PULSE_MAG_2     200000    //nA
#define    STIM_POS_PULSE_WIDTH_2   30000     //us
#define    STIM_NEG_PULSE_MAG_2     200000    //nA
#define    STIM_NEG_PULSE_WIDTH_2   30000     //us

//****************Stimulator 3***************//
#define    STIM_ON_3                0         //1 for on, 0 for off
#define    STIM_CHAN_NUM_3          3         //Stimulation channel number
#define    STIM_PERIOD_3            200000    //us
#define    STIM_POS_PULSE_MAG_3     50000     //nA
#define    STIM_POS_PULSE_WIDTH_3   30000     //us
#define    STIM_NEG_PULSE_MAG_3     200000    //nA
#define    STIM_NEG_PULSE_WIDTH_3   30000     //us
...
int main(void)
{
    ...
    /***********************************************************/
        //Hardcode Values that would've been retrieved from SD card
        sampling_frequency = SAMPLING_FREQ;
        buffer_size = BUFFER_SIZE; // this value is number of bytes (8-bit)
        ...
        channel[0]   = READ_CHAN_0;
        //Stimulator Configurations
        //***********Stimulator 0 ***********//
        stim_on[0] =   STIM_ON_0;
        sti_channel[0] = STIM_CHAN_NUM_0;
        stim_period_temp[0] = STIM_PERIOD_0;
        pos_pulse_magnitude[0] = STIM_POS_PULSE_MAG_0;
        pos_pulse_width_temp[0] = STIM_POS_PULSE_WIDTH_0;
        neg_pulse_magnitude[0] = STIM_NEG_PULSE_MAG_0;
        neg_pulse_width_temp[0] = STIM_NEG_PULSE_WIDTH_0;

        //***********Stimulator 1 ***********//
        stim_on[1] =   STIM_ON_1;
        sti_channel[1] = STIM_CHAN_NUM_1;
        stim_period_temp[1] = STIM_PERIOD_1;
        pos_pulse_magnitude[1] = STIM_POS_PULSE_MAG_1;
        pos_pulse_width_temp[1] = STIM_POS_PULSE_WIDTH_1;
        neg_pulse_magnitude[1] = STIM_NEG_PULSE_MAG_1;
        neg_pulse_width_temp[1] = STIM_NEG_PULSE_WIDTH_1;

        //***********Stimulator 2 ***********//
        stim_on[2] =   STIM_ON_2;
        sti_channel[2] = STIM_CHAN_NUM_2;
        stim_period_temp[2] = STIM_PERIOD_2;
        pos_pulse_magnitude[2] = STIM_POS_PULSE_MAG_2;
        pos_pulse_width_temp[2] = STIM_POS_PULSE_WIDTH_2;
        neg_pulse_magnitude[2] = STIM_NEG_PULSE_MAG_2;
        neg_pulse_width_temp[2] = STIM_NEG_PULSE_WIDTH_2;

        //***********Stimulator 3 ***********//
        stim_on[3] =   STIM_ON_3;
        sti_channel[3] = STIM_CHAN_NUM_3;
        stim_period_temp[3] = STIM_PERIOD_3;
        pos_pulse_magnitude[3] = STIM_POS_PULSE_MAG_3;
        pos_pulse_width_temp[3] = STIM_POS_PULSE_WIDTH_3;
        neg_pulse_magnitude[3] = STIM_NEG_PULSE_MAG_3;
        neg_pulse_width_temp[3] = STIM_NEG_PULSE_WIDTH_3;
